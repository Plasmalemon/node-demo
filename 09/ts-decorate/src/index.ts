...
//   console.log("descriptor", descriptor.value); // descriptor [Function: add]
//   console.log("target[name]", target[name]); // target[name] [Function: add]
//   console.log("target", target); // target Maths {}
